...
class OvertakingWeight extends Weight {
  ...
  /// Acts only on progressions longer than 1 bar (returns 0.0 otherwise).
  /// If [progression] has a chord that takes up [overtaking] or more
  /// of the whole progression's duration, returns 1, otherwise returns 0.
  /// Chords are deemed equal using [ScaleDegreeChord.weakEqual].
  @override
  double score(ScaleDegreeProgression progression, [Scale? scale]) {
    if (progression.duration < progression.timeSignature.decimal) return 0.0;
